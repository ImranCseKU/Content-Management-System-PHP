            ...
            <?php
                ...
                while($row = mysqli_fetch_assoc($select_users)){
                    ...
                    echo "<tr>";
                        ...
                        echo "<td> <a href='users.php?source=edit_user&u_id=$user_id' class='btn btn-sm btn-warning'>Edit</a> </td>";
                        echo "<td> <a href='users.php?delete=$user_id' onclick=\"return confirm('are you sure you want to delete');\" class='btn btn-sm btn-danger'>Delete</a> </td>";
                    echo "</tr>";
                }
